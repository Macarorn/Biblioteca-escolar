...
class _TeacherDashboardState extends State<TeacherDashboard> {
  ...
  // Lista de libros para profesores (puede ser la misma o diferente)
  final List<Map<String, dynamic>> _books = [
    {
      'title': 'Pedagogía General',
      'author': 'Ricardo Nassif',
      'category': 'Educación',
      'available': 5,
      'total': 5,
    },
    {
      'title': 'Didáctica Magna',
      'author': 'Juan Amós Comenio',
      'category': 'Educación',
      'available': 2,
      'total': 3,
    },
  ...
  void initState() {
    super.initState();
    // Simular el cambio de contraseña obligatorio
  ...
  Widget _buildTabs(Color cardColor, Color textColor, Color primaryColor) {
    return Container(
      ...
      child: Row(
        children: [
          _buildTabItem(0, 'Catálogo', Icons.search, textColor, primaryColor),
          _buildTabItem(
            1,
            'Solicitudes',
  ...
  Widget _buildSearchBooks() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        const Text(
          'Busca bibliografía, guías y material de apoyo',
          style: TextStyle(color: Colors.grey),
        ),
        const SizedBox(height: 16),
        TextField(
